    ...
    return (
        <div className="container about">
            ...
            <div className="row">
                ...
                <div className="col-8">
                    <p>Hi, my name is Jon Erik Beckstrand, though I go by my middle name, Erik. I'm 31 years old, although I know that I look about 20, at the most. I was born in Salt Lake City, and have been here my whole life. My dream, however, is to move somewhere else in the country to start, and then possibly move out of the country. At the very least I'd like to travel to as many countries as I possibly can.</p>
                    ...
                    <a className="btn btn-primary" href="#" target="_blank">My Resume</a>
